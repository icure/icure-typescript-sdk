...
export class IccEntitytemplateApi {
 ...
 findAllEntityTemplates(type: string, searchString?: string, includeEntities?: boolean): Promise<Array<EntityTemplate>> {
    ...
    const _url = this.host + `/entitytemplate/findAll/${encodeURIComponent(String(type))}` + "?ts=" + new Date().getTime()  + (searchString ? "&searchString=" + encodeURIComponent(String(searchString)) : "") + (includeEntities ? "&includeEntities=" + encodeURIComponent(String(includeEntities)) : "")
    let headers = this.headers
 ...
 findAllEntityTemplatesByKeyword(type: string, keyword: string, includeEntities?: boolean): Promise<Array<EntityTemplate>> {
    ...
    const _url = this.host + `/entitytemplate/findAll/${encodeURIComponent(String(type))}/keyword/${encodeURIComponent(String(keyword))}` + "?ts=" + new Date().getTime()  + (includeEntities ? "&includeEntities=" + encodeURIComponent(String(includeEntities)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
 ...
 findEntityTemplates(userId: string, type: string, searchString?: string, includeEntities?: boolean): Promise<Array<EntityTemplate>> {
    ...
    const _url = this.host + `/entitytemplate/find/${encodeURIComponent(String(userId))}/${encodeURIComponent(String(type))}` + "?ts=" + new Date().getTime()  + (searchString ? "&searchString=" + encodeURIComponent(String(searchString)) : "") + (includeEntities ? "&includeEntities=" + encodeURIComponent(String(includeEntities)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
 ...
 findEntityTemplatesByKeyword(userId: string, type: string, keyword: string, includeEntities?: boolean): Promise<Array<EntityTemplate>> {
    ...
    const _url = this.host + `/entitytemplate/find/${encodeURIComponent(String(userId))}/${encodeURIComponent(String(type))}/keyword/${encodeURIComponent(String(keyword))}` + "?ts=" + new Date().getTime()  + (includeEntities ? "&includeEntities=" + encodeURIComponent(String(includeEntities)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
