...
export class IccDocumentApi {
 ...
 findByTypeHCPartyMessageSecretFKeys(documentTypeCode: string, hcPartyId: string, secretFKeys: string): Promise<Array<Document>> {
    ...
    const _url = this.host + `/document/byTypeHcPartySecretForeignKeys` + "?ts=" + new Date().getTime()  + (documentTypeCode ? "&documentTypeCode=" + encodeURIComponent(String(documentTypeCode)) : "") + (hcPartyId ? "&hcPartyId=" + encodeURIComponent(String(hcPartyId)) : "") + (secretFKeys ? "&secretFKeys=" + encodeURIComponent(String(secretFKeys)) : "")
    let headers = this.headers
 ...
 findDocumentsByHCPartyPatientForeignKeys(hcPartyId: string, secretFKeys: string): Promise<Array<Document>> {
    ...
    const _url = this.host + `/document/byHcPartySecretForeignKeys` + "?ts=" + new Date().getTime()  + (hcPartyId ? "&hcPartyId=" + encodeURIComponent(String(hcPartyId)) : "") + (secretFKeys ? "&secretFKeys=" + encodeURIComponent(String(secretFKeys)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
 ...
 getDocumentAttachment(documentId: string, attachmentId: string, enckeys?: string, fileName?: string): Promise<ArrayBuffer> {
    ...
    const _url = this.host + `/document/${encodeURIComponent(String(documentId))}/attachment/${encodeURIComponent(String(attachmentId))}` + "?ts=" + new Date().getTime()  + (enckeys ? "&enckeys=" + encodeURIComponent(String(enckeys)) : "") + (fileName ? "&fileName=" + encodeURIComponent(String(fileName)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
          doc.body      )
 ...
 setDocumentAttachment(documentId: string, enckeys?: string, body?: Object): Promise<Document> {
    ...
    const _url = this.host + `/document/${encodeURIComponent(String(documentId))}/attachment` + "?ts=" + new Date().getTime()  + (enckeys ? "&enckeys=" + encodeURIComponent(String(enckeys)) : "")
    let headers = this.headers
 ...
 setDocumentAttachmentBody(documentId: string, enckeys?: string, body?: Object): Promise<Document> {
    ...
    const _url = this.host + `/document/attachment` + "?ts=" + new Date().getTime()  + (documentId ? "&documentId=" + encodeURIComponent(String(documentId)) : "") + (enckeys ? "&enckeys=" + encodeURIComponent(String(enckeys)) : "")
    let headers = this.headers
    headers = headers.filter(h => h.header !== "Content-Type").concat(new XHR.Header("Content-Type", "application/octet-stream"))
    return XHR.sendCommand("PUT", _url, headers, _body, this.fetchImpl)
      .then(doc => 
      ...
      * @param enckeys 
      */
 setDocumentAttachmentMulti(attachment?: ArrayBuffer | any[], documentId: string, enckeys?: string): Promise<Document> {
    let _body = null
        if (attachment && !_body) {
    ...
    const _url = this.host + `/document/${encodeURIComponent(String(documentId))}/attachment/multipart` + "?ts=" + new Date().getTime()  + (enckeys ? "&enckeys=" + encodeURIComponent(String(enckeys)) : "")
    let headers = this.headers
