...
export class IccHcpartyApi {
 ...
 createHealthcareParty(body?: HealthcareParty): Promise<HealthcareParty> {
    ...
    return XHR.sendCommand("POST", _url, headers, _body, this.fetchImpl)
      .then(doc => 
              ...
              new HealthcareParty(doc.body as JSON)
 ...
 deleteHealthcarePartiesInGroup(groupId: string, healthcarePartyIds: string): Promise<Array<DocIdentifier>> {
    ...
    const _url = this.host + `/hcparty/inGroup/${encodeURIComponent(String(groupId))}/${encodeURIComponent(String(healthcarePartyIds))}` + "?ts=" + new Date().getTime() 
    let headers = this.headers
    return XHR.sendCommand("DELETE", _url, headers, _body, this.fetchImpl)
      .then(doc => 
 ...
 findByName(name?: string, startKey?: string, startDocumentId?: string, limit?: number, desc?: boolean): Promise<PaginatedListHealthcareParty> {
    ...
    const _url = this.host + `/hcparty/byName` + "?ts=" + new Date().getTime()  + (name ? "&name=" + encodeURIComponent(String(name)) : "") + (startKey ? "&startKey=" + encodeURIComponent(String(startKey)) : "") + (startDocumentId ? "&startDocumentId=" + encodeURIComponent(String(startDocumentId)) : "") + (limit ? "&limit=" + encodeURIComponent(String(limit)) : "") + (desc ? "&desc=" + encodeURIComponent(String(desc)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
          
              new PaginatedListHealthcareParty(doc.body as JSON)
      ...
      * @param limit Number of rows
      */
 findBySpecialityAndPostCode(type: string, spec: string, firstCode: string, lastCode: string, limit?: number): Promise<PaginatedListHealthcareParty> {
    let _body = null
    
    const _url = this.host + `/hcparty/bySpecialityAndPostCode/${encodeURIComponent(String(type))}/${encodeURIComponent(String(spec))}/${encodeURIComponent(String(firstCode))}/to/${encodeURIComponent(String(lastCode))}` + "?ts=" + new Date().getTime()  + (limit ? "&limit=" + encodeURIComponent(String(limit)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
      ...
      * @param desc Descending
      */
 findBySsinOrNihii(searchValue: string, startKey?: string, startDocumentId?: string, limit?: number, desc?: boolean): Promise<PaginatedListHealthcareParty> {
    let _body = null
    
    const _url = this.host + `/hcparty/byNihiiOrSsin/${encodeURIComponent(String(searchValue))}` + "?ts=" + new Date().getTime()  + (startKey ? "&startKey=" + encodeURIComponent(String(startKey)) : "") + (startDocumentId ? "&startDocumentId=" + encodeURIComponent(String(startDocumentId)) : "") + (limit ? "&limit=" + encodeURIComponent(String(limit)) : "") + (desc ? "&desc=" + encodeURIComponent(String(desc)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
 ...
 getHealthcareParties(healthcarePartyIds: string): Promise<Array<HealthcareParty>> {
    ...
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
              ...
              (doc.body as Array<JSON>).map(it => new HealthcareParty(it))
      )
      .catch(err => this.handleError(err))
}
 ...
 getPublicKey(healthcarePartyId: string): Promise<PublicKey> {
    ...
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
              ...
              new PublicKey(doc.body as JSON)
 ...
 listHealthcareParties(startKey?: string, startDocumentId?: string, limit?: number, desc?: boolean): Promise<PaginatedListHealthcareParty> {
    ...
    const _url = this.host + `/hcparty` + "?ts=" + new Date().getTime()  + (startKey ? "&startKey=" + encodeURIComponent(String(startKey)) : "") + (startDocumentId ? "&startDocumentId=" + encodeURIComponent(String(startDocumentId)) : "") + (limit ? "&limit=" + encodeURIComponent(String(limit)) : "") + (desc ? "&desc=" + encodeURIComponent(String(desc)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
