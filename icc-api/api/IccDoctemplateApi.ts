...
export class IccDoctemplateApi {
 ...
 createDocumentTemplate(body?: DocumentTemplate): Promise<DocumentTemplate> {
    ...
    return XHR.sendCommand("POST", _url, headers, _body, this.fetchImpl)
      .then(doc => 
              ...
              new DocumentTemplate(doc.body as JSON)
 ...
 findAllDocumentTemplates(): Promise<Array<DocumentTemplate>> {
    ...
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
              ...
              (doc.body as Array<JSON>).map(it => new DocumentTemplate(it))
      )
      .catch(err => this.handleError(err))
}
 ...
 getAttachmentText(documentTemplateId: string, attachmentId: string): Promise<ArrayBuffer> {
    ...
    const _url = this.host + `/doctemplate/${encodeURIComponent(String(documentTemplateId))}/attachmentText/${encodeURIComponent(String(attachmentId))}` + "?ts=" + new Date().getTime() 
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
          doc.body      )
 ...
 getDocumentTemplateAttachment(documentTemplateId: string, attachmentId: string): Promise<ArrayBuffer> {
    ...
    const _url = this.host + `/doctemplate/${encodeURIComponent(String(documentTemplateId))}/attachment/${encodeURIComponent(String(attachmentId))}` + "?ts=" + new Date().getTime() 
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
          doc.body      )
