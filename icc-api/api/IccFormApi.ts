...
export class IccFormApi {
 ...
 createFormTemplate(body?: FormTemplate): Promise<FormTemplate> {
    ...
    return XHR.sendCommand("POST", _url, headers, _body, this.fetchImpl)
      .then(doc => 
              ...
              new FormTemplate(doc.body as JSON)
 ...
 findFormTemplates(loadLayout?: boolean): Promise<Array<FormTemplate>> {
    ...
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
              ...
              (doc.body as Array<JSON>).map(it => new FormTemplate(it))
      )
      .catch(err => this.handleError(err))
}
 ...
 findFormTemplatesBySpeciality(specialityCode: string, loadLayout?: boolean): Promise<Array<FormTemplate>> {
    ...
    const _url = this.host + `/form/template/bySpecialty/${encodeURIComponent(String(specialityCode))}` + "?ts=" + new Date().getTime()  + (loadLayout ? "&loadLayout=" + encodeURIComponent(String(loadLayout)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
      ...
      * @param formTemplateId 
      */
 findFormsByHCPartyPatientForeignKeys(hcPartyId: string, secretFKeys: string, healthElementId?: string, planOfActionId?: string, formTemplateId?: string): Promise<Array<Form>> {
    let _body = null
    
    const _url = this.host + `/form/byHcPartySecretForeignKeys` + "?ts=" + new Date().getTime()  + (hcPartyId ? "&hcPartyId=" + encodeURIComponent(String(hcPartyId)) : "") + (secretFKeys ? "&secretFKeys=" + encodeURIComponent(String(secretFKeys)) : "") + (healthElementId ? "&healthElementId=" + encodeURIComponent(String(healthElementId)) : "") + (planOfActionId ? "&planOfActionId=" + encodeURIComponent(String(planOfActionId)) : "") + (formTemplateId ? "&formTemplateId=" + encodeURIComponent(String(formTemplateId)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
 ...
 findFormsDelegationsStubsByHCPartyPatientForeignKeys(hcPartyId: string, secretFKeys: string): Promise<Array<IcureStub>> {
    ...
    const _url = this.host + `/form/byHcPartySecretForeignKeys/delegations` + "?ts=" + new Date().getTime()  + (hcPartyId ? "&hcPartyId=" + encodeURIComponent(String(hcPartyId)) : "") + (secretFKeys ? "&secretFKeys=" + encodeURIComponent(String(secretFKeys)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
 ...
 getFormTemplatesByGuid(formTemplateGuid: string, specialityCode: string): Promise<Array<FormTemplate>> {
    ...
    const _url = this.host + `/form/template/${encodeURIComponent(String(specialityCode))}/guid/${encodeURIComponent(String(formTemplateGuid))}` + "?ts=" + new Date().getTime() 
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
