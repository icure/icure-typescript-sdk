...
export class IccTmpApi {
 ...
 createTmpClassification(body?: Classification): Promise<Classification> {
    ...
    return XHR.sendCommand("POST", _url, headers, _body, this.fetchImpl)
      .then(doc => 
              ...
              new Classification(doc.body as JSON)
 ...
 createTmpClassifications(body?: Array<Classification>): Promise<Array<Classification>> {
    ...
    return XHR.sendCommand("POST", _url, headers, _body, this.fetchImpl)
      .then(doc => 
              ...
              (doc.body as Array<JSON>).map(it => new Classification(it))
      )
      .catch(err => this.handleError(err))
}
 ...
 createTmpDocuments(body?: Array<Document>): Promise<Array<Document>> {
    ...
    return XHR.sendCommand("POST", _url, headers, _body, this.fetchImpl)
      .then(doc => 
              ...
              (doc.body as Array<JSON>).map(it => new Document(it))
      )
      .catch(err => this.handleError(err))
}
 ...
 createTmpEntityTemplate(body?: EntityTemplate): Promise<EntityTemplate> {
    ...
    return XHR.sendCommand("POST", _url, headers, _body, this.fetchImpl)
      .then(doc => 
              ...
              new EntityTemplate(doc.body as JSON)
 ...
 createTmpEntityTemplates(body?: Array<EntityTemplate>): Promise<Array<EntityTemplate>> {
    ...
    return XHR.sendCommand("POST", _url, headers, _body, this.fetchImpl)
      .then(doc => 
              ...
              (doc.body as Array<JSON>).map(it => new EntityTemplate(it))
      )
      .catch(err => this.handleError(err))
}
 ...
 createTmpForms(body?: Array<Form>): Promise<Array<Form>> {
    ...
    return XHR.sendCommand("POST", _url, headers, _body, this.fetchImpl)
      .then(doc => 
              ...
              (doc.body as Array<JSON>).map(it => new Form(it))
      )
      .catch(err => this.handleError(err))
}
 ...
 createTmpHealthElement(body?: HealthElement): Promise<HealthElement> {
    ...
    return XHR.sendCommand("POST", _url, headers, _body, this.fetchImpl)
      .then(doc => 
              ...
              new HealthElement(doc.body as JSON)
 ...
 createTmpHealthElements(body?: Array<HealthElement>): Promise<Array<HealthElement>> {
    ...
    return XHR.sendCommand("POST", _url, headers, _body, this.fetchImpl)
      .then(doc => 
              ...
              (doc.body as Array<JSON>).map(it => new HealthElement(it))
      )
      .catch(err => this.handleError(err))
}
 ...
 createTmpMessages(body?: Array<Message>): Promise<Array<Message>> {
    ...
    return XHR.sendCommand("POST", _url, headers, _body, this.fetchImpl)
      .then(doc => 
              ...
              (doc.body as Array<JSON>).map(it => new Message(it))
      )
      .catch(err => this.handleError(err))
}
 ...
 listTmpClassifications(firstClassificationId?: string, pageSize?: number): Promise<PaginatedListClassification> {
    ...
    const _url = this.host + `/tmp/classification/list` + "?ts=" + new Date().getTime()  + (firstClassificationId ? "&firstClassificationId=" + encodeURIComponent(String(firstClassificationId)) : "") + (pageSize ? "&pageSize=" + encodeURIComponent(String(pageSize)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
          
              new PaginatedListClassification(doc.body as JSON)
 ...
 listTmpContacts(firstContactId?: string, pageSize?: number): Promise<PaginatedListInvoice> {
    ...
    const _url = this.host + `/tmp/contact/list` + "?ts=" + new Date().getTime()  + (firstContactId ? "&firstContactId=" + encodeURIComponent(String(firstContactId)) : "") + (pageSize ? "&pageSize=" + encodeURIComponent(String(pageSize)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
 ...
 listTmpDocuments(firstDocumentId?: string, pageSize?: number): Promise<PaginatedListDocument> {
    ...
    const _url = this.host + `/tmp/document/list` + "?ts=" + new Date().getTime()  + (firstDocumentId ? "&firstDocumentId=" + encodeURIComponent(String(firstDocumentId)) : "") + (pageSize ? "&pageSize=" + encodeURIComponent(String(pageSize)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
          
              new PaginatedListDocument(doc.body as JSON)
 ...
 listTmpEntityTemplates(firstEntityTemplateId?: string, pageSize?: number): Promise<PaginatedListEntityTemplate> {
    ...
    const _url = this.host + `/tmp/entityTemplate/list` + "?ts=" + new Date().getTime()  + (firstEntityTemplateId ? "&firstEntityTemplateId=" + encodeURIComponent(String(firstEntityTemplateId)) : "") + (pageSize ? "&pageSize=" + encodeURIComponent(String(pageSize)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
          
              new PaginatedListEntityTemplate(doc.body as JSON)
 ...
 listTmpForms(firstFormId?: string, pageSize?: number): Promise<PaginatedListForm> {
    ...
    const _url = this.host + `/tmp/form/list` + "?ts=" + new Date().getTime()  + (firstFormId ? "&firstFormId=" + encodeURIComponent(String(firstFormId)) : "") + (pageSize ? "&pageSize=" + encodeURIComponent(String(pageSize)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
          
              new PaginatedListForm(doc.body as JSON)
 ...
 listTmpHealthElements(firstHealthElementId?: string, pageSize?: number): Promise<PaginatedListHealthElement> {
    ...
    const _url = this.host + `/tmp/healthElement/list` + "?ts=" + new Date().getTime()  + (firstHealthElementId ? "&firstHealthElementId=" + encodeURIComponent(String(firstHealthElementId)) : "") + (pageSize ? "&pageSize=" + encodeURIComponent(String(pageSize)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
          
              new PaginatedListHealthElement(doc.body as JSON)
 ...
 listTmpInvoices(firstInvoiceId?: string, pageSize?: number): Promise<PaginatedListInvoice> {
    ...
    const _url = this.host + `/tmp/invoice/list` + "?ts=" + new Date().getTime()  + (firstInvoiceId ? "&firstInvoiceId=" + encodeURIComponent(String(firstInvoiceId)) : "") + (pageSize ? "&pageSize=" + encodeURIComponent(String(pageSize)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
 ...
 listTmpMessages(firstMessageId?: string, pageSize?: number): Promise<PaginatedListInvoice> {
    ...
    const _url = this.host + `/tmp/message/list` + "?ts=" + new Date().getTime()  + (firstMessageId ? "&firstMessageId=" + encodeURIComponent(String(firstMessageId)) : "") + (pageSize ? "&pageSize=" + encodeURIComponent(String(pageSize)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
 ...
 listTmpPatients(firstPatientId?: string, pageSize?: number): Promise<PaginatedListPatient> {
    ...
    const _url = this.host + `/tmp/patient/list` + "?ts=" + new Date().getTime()  + (firstPatientId ? "&firstPatientId=" + encodeURIComponent(String(firstPatientId)) : "") + (pageSize ? "&pageSize=" + encodeURIComponent(String(pageSize)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
