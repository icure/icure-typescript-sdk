...
export class IccUserApi {
 ...
 deleteUserInGroup(groupId: string, userId: string): Promise<Unit> {
    ...
    const _url = this.host + `/user/inGroup/${encodeURIComponent(String(groupId))}/${encodeURIComponent(String(userId))}` + "?ts=" + new Date().getTime() 
    let headers = this.headers
    return XHR.sendCommand("DELETE", _url, headers, _body, this.fetchImpl)
      .then(doc => 
 ...
 getMatchingUsers(): Promise<Array<UserGroup>> {
    ...
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
              ...
              (doc.body as Array<JSON>).map(it => new UserGroup(it))
      )
      .catch(err => this.handleError(err))
}
 ...
 getToken(userId: string, key: string, tokenValidity?: number): Promise<string> {
    ...
    const _url = this.host + `/user/token/${encodeURIComponent(String(userId))}/${encodeURIComponent(String(key))}` + "?ts=" + new Date().getTime()  + (tokenValidity ? "&tokenValidity=" + encodeURIComponent(String(tokenValidity)) : "")
    let headers = this.headers
    return XHR.sendCommand("POST", _url, headers, _body, this.fetchImpl)
      .then(doc => 
 ...
 getTokenInGroup(groupId: string, userId: string, key: string, tokenValidity?: number): Promise<string> {
    ...
    const _url = this.host + `/user/inGroup/${encodeURIComponent(String(groupId))}/token/${encodeURIComponent(String(userId))}/${encodeURIComponent(String(key))}` + "?ts=" + new Date().getTime()  + (tokenValidity ? "&tokenValidity=" + encodeURIComponent(String(tokenValidity)) : "")
    let headers = this.headers
    return XHR.sendCommand("POST", _url, headers, _body, this.fetchImpl)
      .then(doc => 
 ...
 listUsers(startKey?: string, startDocumentId?: string, limit?: number): Promise<PaginatedListUser> {
    ...
    const _url = this.host + `/user` + "?ts=" + new Date().getTime()  + (startKey ? "&startKey=" + encodeURIComponent(String(startKey)) : "") + (startDocumentId ? "&startDocumentId=" + encodeURIComponent(String(startDocumentId)) : "") + (limit ? "&limit=" + encodeURIComponent(String(limit)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
 ...
 listUsersInGroup(groupId: string, startKey?: string, startDocumentId?: string, limit?: number): Promise<PaginatedListUser> {
    ...
    const _url = this.host + `/user/inGroup/${encodeURIComponent(String(groupId))}` + "?ts=" + new Date().getTime()  + (startKey ? "&startKey=" + encodeURIComponent(String(startKey)) : "") + (startDocumentId ? "&startDocumentId=" + encodeURIComponent(String(startDocumentId)) : "") + (limit ? "&limit=" + encodeURIComponent(String(limit)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
