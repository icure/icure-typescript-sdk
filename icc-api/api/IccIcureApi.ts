...
export class IccIcureApi {
 ...
 getIndexingInfo(): Promise<IndexingInfo> {
    ...
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
              ...
              new IndexingInfo(doc.body as JSON)
 ...
 resolveDocumentsConflicts(ids?: string, limit?: number): Promise<Array<Document>> {
    ...
    const _url = this.host + `/icure/conflicts/document` + "?ts=" + new Date().getTime()  + (ids ? "&ids=" + encodeURIComponent(String(ids)) : "") + (limit ? "&limit=" + encodeURIComponent(String(limit)) : "")
    let headers = this.headers
    return XHR.sendCommand("POST", _url, headers, _body, this.fetchImpl)
      .then(doc => 
 ...
 resolveHealthElementsConflicts(limit?: number): Promise<Array<HealthElement>> {
    ...
    const _url = this.host + `/icure/conflicts/healthelement` + "?ts=" + new Date().getTime()  + (limit ? "&limit=" + encodeURIComponent(String(limit)) : "")
    let headers = this.headers
    return XHR.sendCommand("POST", _url, headers, _body, this.fetchImpl)
      .then(doc => 
 ...
 updateDesignDoc(entityName: string, warmup?: boolean): Promise<boolean> {
    ...
    const _url = this.host + `/icure/dd/${encodeURIComponent(String(entityName))}` + "?ts=" + new Date().getTime()  + (warmup ? "&warmup=" + encodeURIComponent(String(warmup)) : "")
    let headers = this.headers
    return XHR.sendCommand("POST", _url, headers, _body, this.fetchImpl)
      .then(doc => 
