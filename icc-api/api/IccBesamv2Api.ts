...
export class IccBesamv2Api {
 ...
 findAmpsByDmppCode(dmppCode: string): Promise<Array<Amp>> {
    ...
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
              ...
              (doc.body as Array<JSON>).map(it => new Amp(it))
      )
 ...
 findPaginatedAmpsByAtc(atcCode: string, startKey?: string, startDocumentId?: string, limit?: number): Promise<PaginatedListAmp> {
    ...
    const _url = this.host + `/be_samv2/vmp/byAtc/${encodeURIComponent(String(atcCode))}` + "?ts=" + new Date().getTime()  + (startKey ? "&startKey=" + encodeURIComponent(String(startKey)) : "") + (startDocumentId ? "&startDocumentId=" + encodeURIComponent(String(startDocumentId)) : "") + (limit ? "&limit=" + encodeURIComponent(String(limit)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
          
              new PaginatedListAmp(doc.body as JSON)
 ...
 findPaginatedAmpsByGroupCode(vmpgCode: string, startKey?: string, startDocumentId?: string, limit?: number): Promise<PaginatedListAmp> {
    ...
    const _url = this.host + `/be_samv2/amp/byGroupCode/${encodeURIComponent(String(vmpgCode))}` + "?ts=" + new Date().getTime()  + (startKey ? "&startKey=" + encodeURIComponent(String(startKey)) : "") + (startDocumentId ? "&startDocumentId=" + encodeURIComponent(String(startDocumentId)) : "") + (limit ? "&limit=" + encodeURIComponent(String(limit)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
 ...
 findPaginatedAmpsByGroupId(vmpgId: string, startKey?: string, startDocumentId?: string, limit?: number): Promise<PaginatedListAmp> {
    ...
    const _url = this.host + `/be_samv2/amp/byGroupId/${encodeURIComponent(String(vmpgId))}` + "?ts=" + new Date().getTime()  + (startKey ? "&startKey=" + encodeURIComponent(String(startKey)) : "") + (startDocumentId ? "&startDocumentId=" + encodeURIComponent(String(startDocumentId)) : "") + (limit ? "&limit=" + encodeURIComponent(String(limit)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
      ...
      * @param limit Number of rows
      */
 findPaginatedAmpsByLabel(language?: string, label?: string, startKey?: string, startDocumentId?: string, limit?: number): Promise<PaginatedListAmp> {
    let _body = null
    
    const _url = this.host + `/be_samv2/amp` + "?ts=" + new Date().getTime()  + (language ? "&language=" + encodeURIComponent(String(language)) : "") + (label ? "&label=" + encodeURIComponent(String(label)) : "") + (startKey ? "&startKey=" + encodeURIComponent(String(startKey)) : "") + (startDocumentId ? "&startDocumentId=" + encodeURIComponent(String(startDocumentId)) : "") + (limit ? "&limit=" + encodeURIComponent(String(limit)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
 ...
 findPaginatedAmpsByVmpCode(vmpCode: string, startKey?: string, startDocumentId?: string, limit?: number): Promise<PaginatedListAmp> {
    ...
    const _url = this.host + `/be_samv2/amp/byVmpCode/${encodeURIComponent(String(vmpCode))}` + "?ts=" + new Date().getTime()  + (startKey ? "&startKey=" + encodeURIComponent(String(startKey)) : "") + (startDocumentId ? "&startDocumentId=" + encodeURIComponent(String(startDocumentId)) : "") + (limit ? "&limit=" + encodeURIComponent(String(limit)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
 ...
 findPaginatedAmpsByVmpId(vmpId: string, startKey?: string, startDocumentId?: string, limit?: number): Promise<PaginatedListAmp> {
    ...
    const _url = this.host + `/be_samv2/amp/byVmpId/${encodeURIComponent(String(vmpId))}` + "?ts=" + new Date().getTime()  + (startKey ? "&startKey=" + encodeURIComponent(String(startKey)) : "") + (startDocumentId ? "&startDocumentId=" + encodeURIComponent(String(startDocumentId)) : "") + (limit ? "&limit=" + encodeURIComponent(String(limit)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
      ...
      * @param limit Number of rows
      */
 findPaginatedNmpsByLabel(language?: string, label?: string, startKey?: string, startDocumentId?: string, limit?: number): Promise<PaginatedListNmp> {
    let _body = null
    ...
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
              ...
              new PaginatedListNmp(doc.body as JSON)
      ...
      * @param limit Number of rows
      */
 findPaginatedVmpGroupsByLabel(language?: string, label?: string, startKey?: string, startDocumentId?: string, limit?: number): Promise<PaginatedListVmpGroup> {
    let _body = null
    ...
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
              ...
              new PaginatedListVmpGroup(doc.body as JSON)
      ...
      * @param limit Number of rows
      */
 findPaginatedVmpGroupsByVmpGroupCode(vmpgCode: string, startKey?: string, startDocumentId?: string, limit?: number): Promise<PaginatedListVmpGroup> {
    let _body = null
    
    const _url = this.host + `/be_samv2/vmpgroup/byGroupCode/${encodeURIComponent(String(vmpgCode))}` + "?ts=" + new Date().getTime()  + (startKey ? "&startKey=" + encodeURIComponent(String(startKey)) : "") + (startDocumentId ? "&startDocumentId=" + encodeURIComponent(String(startDocumentId)) : "") + (limit ? "&limit=" + encodeURIComponent(String(limit)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
 ...
 findPaginatedVmpsByGroupCode(vmpgCode: string, startKey?: string, startDocumentId?: string, limit?: number): Promise<PaginatedListVmp> {
    ...
    const _url = this.host + `/be_samv2/vmp/byGroupCode/${encodeURIComponent(String(vmpgCode))}` + "?ts=" + new Date().getTime()  + (startKey ? "&startKey=" + encodeURIComponent(String(startKey)) : "") + (startDocumentId ? "&startDocumentId=" + encodeURIComponent(String(startDocumentId)) : "") + (limit ? "&limit=" + encodeURIComponent(String(limit)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
          
              new PaginatedListVmp(doc.body as JSON)
 ...
 findPaginatedVmpsByGroupId(vmpgId: string, startKey?: string, startDocumentId?: string, limit?: number): Promise<PaginatedListVmp> {
    ...
    const _url = this.host + `/be_samv2/vmp/byGroupId/${encodeURIComponent(String(vmpgId))}` + "?ts=" + new Date().getTime()  + (startKey ? "&startKey=" + encodeURIComponent(String(startKey)) : "") + (startDocumentId ? "&startDocumentId=" + encodeURIComponent(String(startDocumentId)) : "") + (limit ? "&limit=" + encodeURIComponent(String(limit)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
      ...
      * @param limit Number of rows
      */
 findPaginatedVmpsByLabel(language?: string, label?: string, startKey?: string, startDocumentId?: string, limit?: number): Promise<PaginatedListVmp> {
    let _body = null
 ...
 findPaginatedVmpsByVmpCode(vmpCode: string, startKey?: string, startDocumentId?: string, limit?: number): Promise<PaginatedListVmp> {
    ...
    const _url = this.host + `/be_samv2/vmp/byVmpCode/${encodeURIComponent(String(vmpCode))}` + "?ts=" + new Date().getTime()  + (startKey ? "&startKey=" + encodeURIComponent(String(startKey)) : "") + (startDocumentId ? "&startDocumentId=" + encodeURIComponent(String(startDocumentId)) : "") + (limit ? "&limit=" + encodeURIComponent(String(limit)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
 ...
 getSamVersion(): Promise<SamVersion> {
    ...
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
              ...
              new SamVersion(doc.body as JSON)
 ...
 listNmpsByCnks(body?: ListOfIds): Promise<Array<Nmp>> {
    ...
    return XHR.sendCommand("POST", _url, headers, _body, this.fetchImpl)
      .then(doc => 
              ...
              (doc.body as Array<JSON>).map(it => new Nmp(it))
      )
      .catch(err => this.handleError(err))
}
 ...
 listPharmaceuticalForms(): Promise<Array<PharmaceuticalForm>> {
    ...
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
              ...
              (doc.body as Array<JSON>).map(it => new PharmaceuticalForm(it))
      )
      .catch(err => this.handleError(err))
}
 ...
 listSubstances(): Promise<Array<Substance>> {
    ...
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
              ...
              (doc.body as Array<JSON>).map(it => new Substance(it))
      )
      .catch(err => this.handleError(err))
}
 ...
 listVmpGroupsByVmpGroupCodes(body?: ListOfIds): Promise<Array<VmpGroup>> {
    ...
    return XHR.sendCommand("POST", _url, headers, _body, this.fetchImpl)
      .then(doc => 
              ...
              (doc.body as Array<JSON>).map(it => new VmpGroup(it))
      )
      .catch(err => this.handleError(err))
}
 ...
 listVmpsByGroupIds(body?: ListOfIds): Promise<Array<Vmp>> {
    ...
    return XHR.sendCommand("POST", _url, headers, _body, this.fetchImpl)
      .then(doc => 
              ...
              (doc.body as Array<JSON>).map(it => new Vmp(it))
      )
      .catch(err => this.handleError(err))
}
