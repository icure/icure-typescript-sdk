...
export class IccTarificationApi {
 ...
 createTarification(body?: Tarification): Promise<Tarification> {
    ...
    return XHR.sendCommand("POST", _url, headers, _body, this.fetchImpl)
      .then(doc => 
              ...
              new Tarification(doc.body as JSON)
 ...
 findPaginatedTarifications(region?: string, type?: string, tarification?: string, version?: string, startDocumentId?: string, limit?: number): Promise<PaginatedListTarification> {
    ...
    const _url = this.host + `/tarification` + "?ts=" + new Date().getTime()  + (region ? "&region=" + encodeURIComponent(String(region)) : "") + (type ? "&type=" + encodeURIComponent(String(type)) : "") + (tarification ? "&tarification=" + encodeURIComponent(String(tarification)) : "") + (version ? "&version=" + encodeURIComponent(String(version)) : "") + (startDocumentId ? "&startDocumentId=" + encodeURIComponent(String(startDocumentId)) : "") + (limit ? "&limit=" + encodeURIComponent(String(limit)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
          
              new PaginatedListTarification(doc.body as JSON)
 ...
 findPaginatedTarificationsByLabel(region?: string, types?: string, language?: string, label?: string, startDocumentId?: string, limit?: number): Promise<PaginatedListTarification> {
    ...
    const _url = this.host + `/tarification/byLabel` + "?ts=" + new Date().getTime()  + (region ? "&region=" + encodeURIComponent(String(region)) : "") + (types ? "&types=" + encodeURIComponent(String(types)) : "") + (language ? "&language=" + encodeURIComponent(String(language)) : "") + (label ? "&label=" + encodeURIComponent(String(label)) : "") + (startDocumentId ? "&startDocumentId=" + encodeURIComponent(String(startDocumentId)) : "") + (limit ? "&limit=" + encodeURIComponent(String(limit)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
 ...
 findTarifications(region?: string, type?: string, tarification?: string, version?: string): Promise<Array<Tarification>> {
    ...
    const _url = this.host + `/tarification/byRegionTypeTarification` + "?ts=" + new Date().getTime()  + (region ? "&region=" + encodeURIComponent(String(region)) : "") + (type ? "&type=" + encodeURIComponent(String(type)) : "") + (tarification ? "&tarification=" + encodeURIComponent(String(tarification)) : "") + (version ? "&version=" + encodeURIComponent(String(version)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
          
              (doc.body as Array<JSON>).map(it => new Tarification(it))
      )
      .catch(err => this.handleError(err))
}
 ...
 getTarificationWithParts(type: string, tarification: string, version: string): Promise<Tarification> {
    ...
    const _url = this.host + `/tarification/${encodeURIComponent(String(type))}/${encodeURIComponent(String(tarification))}/${encodeURIComponent(String(version))}` + "?ts=" + new Date().getTime() 
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
