...
export class IccPatientApi {
 ...
 bulkCreatePatients(body?: Array<Patient>): Promise<Array<IdWithRev>> {
    ...
    return XHR.sendCommand("POST", _url, headers, _body, this.fetchImpl)
      .then(doc => 
              ...
              (doc.body as Array<JSON>).map(it => new IdWithRev(it))
      )
 ...
 deletePatient(patientIds: string): Promise<Array<DocIdentifier>> {
    ...
    return XHR.sendCommand("DELETE", _url, headers, _body, this.fetchImpl)
      ...
      */
 filterPatientsBy(startKey?: string, startDocumentId?: string, limit?: number, skip?: number, sort?: string, desc?: boolean, body?: FilterChainPatient): Promise<PaginatedListPatient> {
    let _body = null
    _body = body

    const _url = this.host + `/patient/filter` + "?ts=" + new Date().getTime()  + (startKey ? "&startKey=" + encodeURIComponent(String(startKey)) : "") + (startDocumentId ? "&startDocumentId=" + encodeURIComponent(String(startDocumentId)) : "") + (limit ? "&limit=" + encodeURIComponent(String(limit)) : "") + (skip ? "&skip=" + encodeURIComponent(String(skip)) : "") + (sort ? "&sort=" + encodeURIComponent(String(sort)) : "") + (desc ? "&desc=" + encodeURIComponent(String(desc)) : "")
    let headers = this.headers
    headers = headers.filter(h => h.header !== "Content-Type").concat(new XHR.Header("Content-Type", "application/json"))
    return XHR.sendCommand("POST", _url, headers, _body, this.fetchImpl)
      .then(doc => 
      ...
      * @param limit Number of rows
      */
 findByAccessLogUserAfterDate(userId: string, accessType?: string, startDate?: number, startKey?: string, startDocumentId?: string, limit?: number): Promise<PaginatedListPatient> {
    let _body = null
    
    const _url = this.host + `/patient/byAccess/${encodeURIComponent(String(userId))}` + "?ts=" + new Date().getTime()  + (accessType ? "&accessType=" + encodeURIComponent(String(accessType)) : "") + (startDate ? "&startDate=" + encodeURIComponent(String(startDate)) : "") + (startKey ? "&startKey=" + encodeURIComponent(String(startKey)) : "") + (startDocumentId ? "&startDocumentId=" + encodeURIComponent(String(startDocumentId)) : "") + (limit ? "&limit=" + encodeURIComponent(String(limit)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
 ...
 findByExternalId(externalId: string): Promise<Patient> {
    ...
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      ...
      */
 findByNameBirthSsinAuto(healthcarePartyId?: string, filterValue?: string, startKey?: string, startDocumentId?: string, limit?: number, sortDirection?: string): Promise<PaginatedListPatient> {
    let _body = null
    
    const _url = this.host + `/patient/byNameBirthSsinAuto` + "?ts=" + new Date().getTime()  + (healthcarePartyId ? "&healthcarePartyId=" + encodeURIComponent(String(healthcarePartyId)) : "") + (filterValue ? "&filterValue=" + encodeURIComponent(String(filterValue)) : "") + (startKey ? "&startKey=" + encodeURIComponent(String(startKey)) : "") + (startDocumentId ? "&startDocumentId=" + encodeURIComponent(String(startDocumentId)) : "") + (limit ? "&limit=" + encodeURIComponent(String(limit)) : "") + (sortDirection ? "&sortDirection=" + encodeURIComponent(String(sortDirection)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
 ...
 findDuplicatesByName(hcPartyId: string, startKey?: string, startDocumentId?: string, limit?: number): Promise<PaginatedListPatient> {
    ...
    const _url = this.host + `/patient/duplicates/name` + "?ts=" + new Date().getTime()  + (hcPartyId ? "&hcPartyId=" + encodeURIComponent(String(hcPartyId)) : "") + (startKey ? "&startKey=" + encodeURIComponent(String(startKey)) : "") + (startDocumentId ? "&startDocumentId=" + encodeURIComponent(String(startDocumentId)) : "") + (limit ? "&limit=" + encodeURIComponent(String(limit)) : "")
    let headers = this.headers
    return XHR.sendCommand("POST", _url, headers, _body, this.fetchImpl)
      .then(doc => 
 ...
 findDuplicatesBySsin(hcPartyId: string, startKey?: string, startDocumentId?: string, limit?: number): Promise<PaginatedListPatient> {
    ...
    const _url = this.host + `/patient/duplicates/ssin` + "?ts=" + new Date().getTime()  + (hcPartyId ? "&hcPartyId=" + encodeURIComponent(String(hcPartyId)) : "") + (startKey ? "&startKey=" + encodeURIComponent(String(startKey)) : "") + (startDocumentId ? "&startDocumentId=" + encodeURIComponent(String(startDocumentId)) : "") + (limit ? "&limit=" + encodeURIComponent(String(limit)) : "")
    let headers = this.headers
    return XHR.sendCommand("POST", _url, headers, _body, this.fetchImpl)
      .then(doc => 
 ...
 fuzzySearch(firstName?: string, lastName?: string, dateOfBirth?: number): Promise<Array<Patient>> {
    ...
    const _url = this.host + `/patient/fuzzy` + "?ts=" + new Date().getTime()  + (firstName ? "&firstName=" + encodeURIComponent(String(firstName)) : "") + (lastName ? "&lastName=" + encodeURIComponent(String(lastName)) : "") + (dateOfBirth ? "&dateOfBirth=" + encodeURIComponent(String(dateOfBirth)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
          
              (doc.body as Array<JSON>).map(it => new Patient(it))
      )
      .catch(err => this.handleError(err))
}
 ...
 listDeletedPatients(startDate?: number, endDate?: number, desc?: boolean, startDocumentId?: string, limit?: number): Promise<PaginatedListPatient> {
    ...
    const _url = this.host + `/patient/deleted/by_date` + "?ts=" + new Date().getTime()  + (startDate ? "&startDate=" + encodeURIComponent(String(startDate)) : "") + (endDate ? "&endDate=" + encodeURIComponent(String(endDate)) : "") + (desc ? "&desc=" + encodeURIComponent(String(desc)) : "") + (startDocumentId ? "&startDocumentId=" + encodeURIComponent(String(startDocumentId)) : "") + (limit ? "&limit=" + encodeURIComponent(String(limit)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
 ...
 listDeletedPatientsByName(firstName?: string, lastName?: string): Promise<Array<Patient>> {
    ...
    const _url = this.host + `/patient/deleted/by_name` + "?ts=" + new Date().getTime()  + (firstName ? "&firstName=" + encodeURIComponent(String(firstName)) : "") + (lastName ? "&lastName=" + encodeURIComponent(String(lastName)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
 ...
 listOfPatientsModifiedAfter(date: number, startKey?: number, startDocumentId?: string, limit?: number): Promise<PaginatedListPatient> {
    ...
    const _url = this.host + `/patient/modifiedAfter/${encodeURIComponent(String(date))}` + "?ts=" + new Date().getTime()  + (startKey ? "&startKey=" + encodeURIComponent(String(startKey)) : "") + (startDocumentId ? "&startDocumentId=" + encodeURIComponent(String(startDocumentId)) : "") + (limit ? "&limit=" + encodeURIComponent(String(limit)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
      ...
      * @param sortDirection Optional value for providing a sorting direction (&#x27;asc&#x27;, &#x27;desc&#x27;). Set to &#x27;asc&#x27; by default.
      */
 listPatients(hcPartyId?: string, sortField?: string, startKey?: string, startDocumentId?: string, limit?: number, sortDirection?: string): Promise<PaginatedListPatient> {
    let _body = null
    
    const _url = this.host + `/patient` + "?ts=" + new Date().getTime()  + (hcPartyId ? "&hcPartyId=" + encodeURIComponent(String(hcPartyId)) : "") + (sortField ? "&sortField=" + encodeURIComponent(String(sortField)) : "") + (startKey ? "&startKey=" + encodeURIComponent(String(startKey)) : "") + (startDocumentId ? "&startDocumentId=" + encodeURIComponent(String(startDocumentId)) : "") + (limit ? "&limit=" + encodeURIComponent(String(limit)) : "") + (sortDirection ? "&sortDirection=" + encodeURIComponent(String(sortDirection)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
      ...
      * @param sortDirection Optional value for providing a sorting direction (&#x27;asc&#x27;, &#x27;desc&#x27;). Set to &#x27;asc&#x27; by default.
      */
 listPatientsByHcParty(hcPartyId: string, sortField?: string, startKey?: string, startDocumentId?: string, limit?: number, sortDirection?: string): Promise<PaginatedListPatient> {
    let _body = null
    
    const _url = this.host + `/patient/hcParty/${encodeURIComponent(String(hcPartyId))}` + "?ts=" + new Date().getTime()  + (sortField ? "&sortField=" + encodeURIComponent(String(sortField)) : "") + (startKey ? "&startKey=" + encodeURIComponent(String(startKey)) : "") + (startDocumentId ? "&startDocumentId=" + encodeURIComponent(String(startDocumentId)) : "") + (limit ? "&limit=" + encodeURIComponent(String(limit)) : "") + (sortDirection ? "&sortDirection=" + encodeURIComponent(String(sortDirection)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
 ...
 listPatientsIds(hcPartyId: string, startKey?: string, startDocumentId?: string, limit?: number): Promise<PaginatedListString> {
    ...
    const _url = this.host + `/patient/idsPages` + "?ts=" + new Date().getTime()  + (hcPartyId ? "&hcPartyId=" + encodeURIComponent(String(hcPartyId)) : "") + (startKey ? "&startKey=" + encodeURIComponent(String(startKey)) : "") + (startDocumentId ? "&startDocumentId=" + encodeURIComponent(String(startDocumentId)) : "") + (limit ? "&limit=" + encodeURIComponent(String(limit)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
          
              new PaginatedListString(doc.body as JSON)
      ...
      * @param sortDirection Optional value for providing a sorting direction (&#x27;asc&#x27;, &#x27;desc&#x27;). Set to &#x27;asc&#x27; by default.
      */
 listPatientsOfHcParty(hcPartyId: string, sortField?: string, startKey?: string, startDocumentId?: string, limit?: number, sortDirection?: string): Promise<PaginatedListPatient> {
    let _body = null
    
    const _url = this.host + `/patient/ofHcParty/${encodeURIComponent(String(hcPartyId))}` + "?ts=" + new Date().getTime()  + (sortField ? "&sortField=" + encodeURIComponent(String(sortField)) : "") + (startKey ? "&startKey=" + encodeURIComponent(String(startKey)) : "") + (startDocumentId ? "&startDocumentId=" + encodeURIComponent(String(startDocumentId)) : "") + (limit ? "&limit=" + encodeURIComponent(String(limit)) : "") + (sortDirection ? "&sortDirection=" + encodeURIComponent(String(sortDirection)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
 ...
 modifyPatientReferral(patientId: string, referralId: string, start?: number, end?: number): Promise<Patient> {
    ...
    const _url = this.host + `/patient/${encodeURIComponent(String(patientId))}/referral/${encodeURIComponent(String(referralId))}` + "?ts=" + new Date().getTime()  + (start ? "&start=" + encodeURIComponent(String(start)) : "") + (end ? "&end=" + encodeURIComponent(String(end)) : "")
    let headers = this.headers
    return XHR.sendCommand("PUT", _url, headers, _body, this.fetchImpl)
      .then(doc => 
