...
export class IccHelementApi {
   ...
   * @param hcPartyId
   */
  findHealthElementsByHCPartyPatientForeignKeysUsingPost(hcPartyId: string, body?: Array<string>): Promise<Array<HealthElement>> {
    let _body = null
    _body = body
   ...
   * @param hcPartyId
   */
  findHealthElementsDelegationsStubsByHCPartyPatientForeignKeysUsingPost(hcPartyId: string, body?: Array<string>): Promise<Array<IcureStub>> {
    let _body = null
    _body = body
