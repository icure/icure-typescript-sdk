...
export class IccCodeApi {
 ...
 createCode(body?: Code): Promise<Code> {
    ...
    return XHR.sendCommand("POST", _url, headers, _body, this.fetchImpl)
      ...
      */
 filterCodesBy(startKey?: string, startDocumentId?: string, limit?: number, skip?: number, sort?: string, desc?: boolean, body?: FilterChainCode): Promise<PaginatedListCode> {
    let _body = null
    _body = body
    ...
    return XHR.sendCommand("POST", _url, headers, _body, this.fetchImpl)
      .then(doc => 
              ...
              new PaginatedListCode(doc.body as JSON)
 ...
 findCodeTypes(region?: string, type?: string): Promise<Array<string>> {
    ...
    const _url = this.host + `/code/codetype/byRegionType` + "?ts=" + new Date().getTime()  + (region ? "&region=" + encodeURIComponent(String(region)) : "") + (type ? "&type=" + encodeURIComponent(String(type)) : "")
    let headers = this.headers
 ...
 findCodes(region?: string, type?: string, code?: string, version?: string): Promise<Array<Code>> {
    ...
    const _url = this.host + `/code/byRegionTypeCode` + "?ts=" + new Date().getTime()  + (region ? "&region=" + encodeURIComponent(String(region)) : "") + (type ? "&type=" + encodeURIComponent(String(type)) : "") + (code ? "&code=" + encodeURIComponent(String(code)) : "") + (version ? "&version=" + encodeURIComponent(String(version)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
          
              (doc.body as Array<JSON>).map(it => new Code(it))
      )
      .catch(err => this.handleError(err))
}
      ...
      * @param limit Number of rows
      */
 findPaginatedCodes(region?: string, type?: string, code?: string, version?: string, startKey?: string, startDocumentId?: string, limit?: number): Promise<PaginatedListCode> {
    let _body = null
    
    const _url = this.host + `/code` + "?ts=" + new Date().getTime()  + (region ? "&region=" + encodeURIComponent(String(region)) : "") + (type ? "&type=" + encodeURIComponent(String(type)) : "") + (code ? "&code=" + encodeURIComponent(String(code)) : "") + (version ? "&version=" + encodeURIComponent(String(version)) : "") + (startKey ? "&startKey=" + encodeURIComponent(String(startKey)) : "") + (startDocumentId ? "&startDocumentId=" + encodeURIComponent(String(startDocumentId)) : "") + (limit ? "&limit=" + encodeURIComponent(String(limit)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
 ...
 findPaginatedCodesByLabel(region?: string, types?: string, language?: string, label?: string, startKey?: string, startDocumentId?: string, limit?: number): Promise<PaginatedListCode> {
    ...
    const _url = this.host + `/code/byLabel` + "?ts=" + new Date().getTime()  + (region ? "&region=" + encodeURIComponent(String(region)) : "") + (types ? "&types=" + encodeURIComponent(String(types)) : "") + (language ? "&language=" + encodeURIComponent(String(language)) : "") + (label ? "&label=" + encodeURIComponent(String(label)) : "") + (startKey ? "&startKey=" + encodeURIComponent(String(startKey)) : "") + (startDocumentId ? "&startDocumentId=" + encodeURIComponent(String(startDocumentId)) : "") + (limit ? "&limit=" + encodeURIComponent(String(limit)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
      ...
      * @param limit Number of rows
      */
 findPaginatedCodesWithLink(linkType: string, linkedId?: string, startKey?: string, startDocumentId?: string, limit?: number): Promise<PaginatedListCode> {
    let _body = null
    
    const _url = this.host + `/code/link/${encodeURIComponent(String(linkType))}` + "?ts=" + new Date().getTime()  + (linkedId ? "&linkedId=" + encodeURIComponent(String(linkedId)) : "") + (startKey ? "&startKey=" + encodeURIComponent(String(startKey)) : "") + (startDocumentId ? "&startDocumentId=" + encodeURIComponent(String(startDocumentId)) : "") + (limit ? "&limit=" + encodeURIComponent(String(limit)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
 ...
 findTagTypes(region?: string, type?: string): Promise<Array<string>> {
    ...
    const _url = this.host + `/code/tagtype/byRegionType` + "?ts=" + new Date().getTime()  + (region ? "&region=" + encodeURIComponent(String(region)) : "") + (type ? "&type=" + encodeURIComponent(String(type)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
 ...
 getCodeWithParts(type: string, code: string, version: string): Promise<Code> {
    ...
    const _url = this.host + `/code/${encodeURIComponent(String(type))}/${encodeURIComponent(String(code))}/${encodeURIComponent(String(version))}` + "?ts=" + new Date().getTime() 
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
