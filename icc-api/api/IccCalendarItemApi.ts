...
export class IccCalendarItemApi {
 ...
 createCalendarItem(body?: CalendarItem): Promise<CalendarItem> {
    ...
    return XHR.sendCommand("POST", _url, headers, _body, this.fetchImpl)
      .then(doc => 
              ...
              new CalendarItem(doc.body as JSON)
 ...
 findCalendarItemsByHCPartyPatientForeignKeys(hcPartyId: string, secretFKeys: string): Promise<Array<CalendarItem>> {
    ...
    const _url = this.host + `/calendarItem/byHcPartySecretForeignKeys` + "?ts=" + new Date().getTime()  + (hcPartyId ? "&hcPartyId=" + encodeURIComponent(String(hcPartyId)) : "") + (secretFKeys ? "&secretFKeys=" + encodeURIComponent(String(secretFKeys)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
          
              (doc.body as Array<JSON>).map(it => new CalendarItem(it))
      )
      .catch(err => this.handleError(err))
}
 ...
 findCalendarItemsByRecurrenceId(recurrenceId: string): Promise<Array<CalendarItem>> {
    ...
    const _url = this.host + `/calendarItem/byRecurrenceId` + "?ts=" + new Date().getTime()  + (recurrenceId ? "&recurrenceId=" + encodeURIComponent(String(recurrenceId)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
 ...
 getCalendarItemsByPeriodAndHcPartyId(startDate: number, endDate: number, hcPartyId: string): Promise<Array<CalendarItem>> {
    ...
    const _url = this.host + `/calendarItem/byPeriodAndHcPartyId` + "?ts=" + new Date().getTime()  + (startDate ? "&startDate=" + encodeURIComponent(String(startDate)) : "") + (endDate ? "&endDate=" + encodeURIComponent(String(endDate)) : "") + (hcPartyId ? "&hcPartyId=" + encodeURIComponent(String(hcPartyId)) : "")
    let headers = this.headers
    return XHR.sendCommand("POST", _url, headers, _body, this.fetchImpl)
      .then(doc => 
 ...
 getCalendarsByPeriodAndAgendaId(startDate: number, endDate: number, agendaId: string): Promise<Array<CalendarItem>> {
    ...
    const _url = this.host + `/calendarItem/byPeriodAndAgendaId` + "?ts=" + new Date().getTime()  + (startDate ? "&startDate=" + encodeURIComponent(String(startDate)) : "") + (endDate ? "&endDate=" + encodeURIComponent(String(endDate)) : "") + (agendaId ? "&agendaId=" + encodeURIComponent(String(agendaId)) : "")
    let headers = this.headers
    return XHR.sendCommand("POST", _url, headers, _body, this.fetchImpl)
      .then(doc => 
