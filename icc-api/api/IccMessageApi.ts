...
export class IccMessageApi {
 ...
 deleteDelegation(messageId: string, delegateId: string): Promise<Message> {
    ...
    const _url = this.host + `/message/${encodeURIComponent(String(messageId))}/delegate/${encodeURIComponent(String(delegateId))}` + "?ts=" + new Date().getTime() 
    let headers = this.headers
 ...
 findMessages(startKey?: string, startDocumentId?: string, limit?: number): Promise<PaginatedListMessage> {
    ...
    const _url = this.host + `/message` + "?ts=" + new Date().getTime()  + (startKey ? "&startKey=" + encodeURIComponent(String(startKey)) : "") + (startDocumentId ? "&startDocumentId=" + encodeURIComponent(String(startDocumentId)) : "") + (limit ? "&limit=" + encodeURIComponent(String(limit)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
          
              new PaginatedListMessage(doc.body as JSON)
      ...
      * @param hcpId 
      */
 findMessagesByFromAddress(fromAddress?: string, startKey?: string, startDocumentId?: string, limit?: number, hcpId?: string): Promise<PaginatedListMessage> {
    let _body = null
    
    const _url = this.host + `/message/byFromAddress` + "?ts=" + new Date().getTime()  + (fromAddress ? "&fromAddress=" + encodeURIComponent(String(fromAddress)) : "") + (startKey ? "&startKey=" + encodeURIComponent(String(startKey)) : "") + (startDocumentId ? "&startDocumentId=" + encodeURIComponent(String(startDocumentId)) : "") + (limit ? "&limit=" + encodeURIComponent(String(limit)) : "") + (hcpId ? "&hcpId=" + encodeURIComponent(String(hcpId)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
 ...
 findMessagesByHCPartyPatientForeignKeys(secretFKeys: string): Promise<Array<Message>> {
    ...
    const _url = this.host + `/message/byHcPartySecretForeignKeys` + "?ts=" + new Date().getTime()  + (secretFKeys ? "&secretFKeys=" + encodeURIComponent(String(secretFKeys)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
      ...
      * @param hcpId 
      */
 findMessagesByToAddress(toAddress?: string, startKey?: string, startDocumentId?: string, limit?: number, reverse?: boolean, hcpId?: string): Promise<PaginatedListMessage> {
    let _body = null
    
    const _url = this.host + `/message/byToAddress` + "?ts=" + new Date().getTime()  + (toAddress ? "&toAddress=" + encodeURIComponent(String(toAddress)) : "") + (startKey ? "&startKey=" + encodeURIComponent(String(startKey)) : "") + (startDocumentId ? "&startDocumentId=" + encodeURIComponent(String(startDocumentId)) : "") + (limit ? "&limit=" + encodeURIComponent(String(limit)) : "") + (reverse ? "&reverse=" + encodeURIComponent(String(reverse)) : "") + (hcpId ? "&hcpId=" + encodeURIComponent(String(hcpId)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
      ...
      * @param hcpId 
      */
 findMessagesByTransportGuid(transportGuid?: string, received?: boolean, startKey?: string, startDocumentId?: string, limit?: number, hcpId?: string): Promise<PaginatedListMessage> {
    let _body = null
    
    const _url = this.host + `/message/byTransportGuid` + "?ts=" + new Date().getTime()  + (transportGuid ? "&transportGuid=" + encodeURIComponent(String(transportGuid)) : "") + (received ? "&received=" + encodeURIComponent(String(received)) : "") + (startKey ? "&startKey=" + encodeURIComponent(String(startKey)) : "") + (startDocumentId ? "&startDocumentId=" + encodeURIComponent(String(startDocumentId)) : "") + (limit ? "&limit=" + encodeURIComponent(String(limit)) : "") + (hcpId ? "&hcpId=" + encodeURIComponent(String(hcpId)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
      ...
      * @param hcpId 
      */
 findMessagesByTransportGuidSentDate(transportGuid?: string, from?: number, to?: number, startKey?: string, startDocumentId?: string, limit?: number, hcpId?: string): Promise<PaginatedListMessage> {
    let _body = null
    
    const _url = this.host + `/message/byTransportGuidSentDate` + "?ts=" + new Date().getTime()  + (transportGuid ? "&transportGuid=" + encodeURIComponent(String(transportGuid)) : "") + (from ? "&from=" + encodeURIComponent(String(from)) : "") + (to ? "&to=" + encodeURIComponent(String(to)) : "") + (startKey ? "&startKey=" + encodeURIComponent(String(startKey)) : "") + (startDocumentId ? "&startDocumentId=" + encodeURIComponent(String(startDocumentId)) : "") + (limit ? "&limit=" + encodeURIComponent(String(limit)) : "") + (hcpId ? "&hcpId=" + encodeURIComponent(String(hcpId)) : "")
    let headers = this.headers
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => 
 ...
 newMessageDelegations(messageId: string, body?: Array<Delegation>): Promise<IcureStub> {
    ...
    return XHR.sendCommand("PUT", _url, headers, _body, this.fetchImpl)
      .then(doc => 
              ...
              new IcureStub(doc.body as JSON)
