...
async function initialiseCryptoWithProvider(
	...
	const exchangeDataApi = new IccExchangeDataApi(host, params.headers, groupSpecificAuthenticationProvider, fetchImpl)
	...
	const userEncryptionKeysManager = new UserEncryptionKeysManager(cryptoPrimitives, dataOwnerApi, icureStorage, keyRecovery, baseExchangeKeysManager, cryptoStrategies, !params.disableParentKeysInitialisation)
	...
	const exchangeDataMapManager = new ExchangeDataMapManager(new IccExchangeDataMapApi(host, params.headers, groupSpecificAuthenticationProvider, fetchImpl))
	...
	const accessLogApi = new IccAccesslogXApi(host, params.headers, cryptoApi, dataOwnerApi, groupSpecificAuthenticationProvider, fetchImpl)
	const agendaApi = new IccAgendaApi(host, params.headers, groupSpecificAuthenticationProvider, fetchImpl)
	const contactApi = new IccContactXApi(host, params.headers, cryptoApi, dataOwnerApi, groupSpecificAuthenticationProvider, fetchImpl)
	const formApi = new IccFormXApi(host, params.headers, cryptoApi, dataOwnerApi, groupSpecificAuthenticationProvider, fetchImpl)
	const groupApi = new IccGroupApi(host, params.headers, groupSpecificAuthenticationProvider)
	const medicalLocationApi = new IccMedicallocationApi(host, params.headers, groupSpecificAuthenticationProvider)
	const calendarItemTypeApi = new IccCalendarItemTypeApi(host, params.headers, groupSpecificAuthenticationProvider)
	const invoiceApi = new IccInvoiceXApi(host, params.headers, cryptoApi, entityReferenceApi, dataOwnerApi, groupSpecificAuthenticationProvider, fetchImpl)
	const insuranceApi = new IccInsuranceApi(host, params.headers, groupSpecificAuthenticationProvider, fetchImpl)
	const documentApi = new IccDocumentXApi(host, params.headers, cryptoApi, authApi, dataOwnerApi, groupSpecificAuthenticationProvider, fetchImpl)
	...
	const classificationApi = new IccClassificationXApi(host, params.headers, cryptoApi, dataOwnerApi, groupSpecificAuthenticationProvider, fetchImpl)
	...
	const receiptApi = new IccReceiptXApi(host, params.headers, cryptoApi, dataOwnerApi, groupSpecificAuthenticationProvider, fetchImpl)
	const timetableApi = new IccTimeTableXApi(host, params.headers, cryptoApi, dataOwnerApi, groupSpecificAuthenticationProvider, fetchImpl)
	...
	const messageApi = new IccMessageXApi(host, params.headers, cryptoApi, dataOwnerApi, groupSpecificAuthenticationProvider, fetchImpl)
...
export const BasicApis = async function (
	...
	const userApi = new IccUserXApi(host, headers, groupSpecificAuthenticationProvider, fetchImpl)
	...
	const healthcarePartyApi = new IccHcpartyXApi(host, headers, groupSpecificAuthenticationProvider, fetchImpl)
