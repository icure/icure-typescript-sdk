...
import { EnsembleAuthenticationProvider } from './auth/AuthenticationProvider'
...
export const Api = async function (
  ...
  const authenticationProvider = new EnsembleAuthenticationProvider(authApi, username, password)
