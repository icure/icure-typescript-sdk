...
/**
 * Implementation of crypto strategies which should closely resemble a basic legacy behaviour of the crypto api, except for data owner delegation
 ...
 * - Requires anonymous delegations for all data owners which are not hcps
 */
